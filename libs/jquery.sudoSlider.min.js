...
f(a).load(function(){e(a)}).error(function(){e(a)});if("complete"==a.readyState)f(a).trigger("load");else if(a.readyState)a.src=a.src;else if(a.complete)f(a).trigger("load");else if(void 0===a.complete){var d=a.src;a.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==";a.src=d}})}function X(d,b){a[19]&&sa(d,b,e);a[39]&&sa(d,b,c)}function sa(a,b,e){R.ready(function(){ta(a,b,e);ba(m.eq(a),c,function(){ta(a,b,e)})})}function ta(d,b,e){d=s(d);l=m.eq(d)[e?"height":"width"]();R.animate(e?
